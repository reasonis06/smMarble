...
typedef enum {
    GRADE_A_PLUS = 0, GRADE_A_ZERO, GRADE_A_MINUS,
    GRADE_B_PLUS, GRADE_B_ZERO, GRADE_B_MINUS,
    GRADE_C_PLUS, GRADE_C_ZERO, GRADE_C_MINUS,
...
char* smmObj_getHistoryLectureName(smmObj_t* node);
int smmObj_getHistoryCredit(smmObj_t* node);
smmGrade_e smmObj_getHistoryGrade(smmObj_t* node);
smmObj_t* smmObj_getNextHistoryNode(smmObj_t* node);
